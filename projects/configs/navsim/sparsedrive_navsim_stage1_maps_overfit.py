# Phase-2 overfit gate (NAVSIM_SPARSEDRIVE_PORT.md): detection + map on the
# same frozen manifest of the first eight sorted navmini tokens as the
# Phase-1 gate. Gate: total detection AND map losses fall by >= 95% from
# their first-20-step means.
#
# Mirrors sparsedrive_navsim_stage1_overfit.py exactly (no photometric
# jitter, no grid mask, no flips/rotation, deterministic resize/crop,
# sequences_split_num="all"), plus VectorizeMap + map GT keys.
